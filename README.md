...
To see what a repository for use as assignment starter code looks like, ~~[visit this repository](https://github.com/colematt/classroom-demo-assn).~~ **See issue [#1](https://github.com/colematt/hello-classroom/issues/1)**
